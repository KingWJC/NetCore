namespace ADF.DataAccess
{
    public class BaseService
    {
        ...
        // /// <returns>有效值</returns>
        // public static object GetValueObject(object propValue)
        // {
        //     if (propValue == null)
        //     {
        //         return "NULL";
        ...
        // {
        //     DataSet ds = DbHelperUtil.Query(DBType.oracle, ConnectionString, sql);
        //     if (ds == null)
        //     {
        //         return null;
        //     }
        ...
        public int GetCount()
        {
            var server = ADF.DataAccess.DbFactory.Oracle("Data Source=192.168.100.91/orcl;User ID=JHZM;Password=JHZM;");
